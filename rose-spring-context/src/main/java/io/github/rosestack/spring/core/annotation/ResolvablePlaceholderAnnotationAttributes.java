...
import static io.github.rosestack.util.ArrayUtils.length;
...
public class ResolvablePlaceholderAnnotationAttributes<A extends Annotation> extends GenericAnnotationAttributes<A> {
    ...
    public ResolvablePlaceholderAnnotationAttributes(@Nonnull A annotation, @Nullable PropertyResolver propertyResolver) {
        this(AnnotationUtils.getAnnotationAttributes(annotation, false), (Class<A>) annotation.annotationType(), propertyResolver);
    }

    public ResolvablePlaceholderAnnotationAttributes(AnnotationAttributes another, @Nullable PropertyResolver propertyResolver) {
        this(another, AnnotationUtils.findAnnotationType(another), propertyResolver);
    }
    ...
    private static Map<String, Object> resolvePlaceholders(Map<String, Object> source, @Nullable PropertyResolver propertyResolver) {
        ...
        Map<String, Object> copy = MapUtils.shallowCloneMap(source);
