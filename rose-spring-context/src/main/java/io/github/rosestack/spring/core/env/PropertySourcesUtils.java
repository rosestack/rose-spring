package io.github.rosestack.spring.core.env;
...
import static io.github.rosestack.util.MapUtils.MIN_LOAD_FACTOR;
...
public abstract class PropertySourcesUtils {
    ...
    public static String[] getPropertyNames(PropertySource propertySource) {
        ...
        if (propertyNames == null) {
            propertyNames = ArrayUtils.EMPTY_STRING_ARRAY;
        }
    ...
    public static Map<String, Object> getProperties(PropertySource propertySource) {
        ...
        Map<String, Object> properties = new LinkedHashMap<>(length, MIN_LOAD_FACTOR);
